...
public class TrackingWheelLocalizerImpl extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.239; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.02; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.9908; // Multiplier in the X direction
